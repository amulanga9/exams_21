...
Интерактивное веб-приложение для подготовки к экзамену School 42/21 Rank 02 + **автоматическая система проверки как Verter** + **задания из piscine**.
...
![Piscine](https://img.shields.io/badge/Piscine-Integrated-purple)
...
### 🏊 Piscine интеграция (НОВОЕ!)
- ✅ **34+ заданий из бассейна** School 21
- ✅ **Stdin/Stdout тестирование**
- ✅ **Актуальные задания** (свежепройденные)
- ✅ **Отдельная категория** тестов
...
- [PISCINE_INTEGRATION.md](PISCINE_INTEGRATION.md) - 🆕 Интеграция заданий из piscine
